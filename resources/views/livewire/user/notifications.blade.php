    ...
    <div class="p-6 space-y-4">
        <div class="flex items-center justify-between">
            ...
            <div class="flex items-center gap-2 text-sm">
                ...
                <a href="/dashboard" class="btn-3d-neutral" wire:navigate>Dashboard</a>
            </div>
        </div>
        ...
        document.addEventListener('DOMContentLoaded', () => {
            async function load() {
                ...
                data.forEach(n => {
                    ...
                    item.className = 'p-2 rounded border border-neutral-200 dark:border-neutral-700 bg-white dark:bg-zinc-900';
                    item.innerHTML = `<div class="font-medium">${n.title}</div><div class="text-sm text-zinc-600">${n.body}</div>`;
