<x-layouts.app title="Create Building">
    <div class="p-6 max-w-xl">
        <h1 class="text-lg font-semibold mb-4">Create Building</h1>
        <form method="POST" action="{{ url('/admin/buildings') }}" class="space-y-4">
            @csrf
            <div>
            ...
            <div>
                ...
                <textarea name="address" class="input-3d w-full"></textarea>
            </div>
